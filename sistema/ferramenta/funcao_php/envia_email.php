...
function envia_email($tipo_envio,$destinatario,$assunto,$remetente_email,$remetente_nome) {
	
	switch($tipo_envio){
		case 'parceria-construtora':
																									...
																									<tr>
																										<td align="left" class="textContent">
																											<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																												Este e-mail foi enviado para '.$destinatario.'
																											</div>
																										</td>
																									</tr>
																								</table>
