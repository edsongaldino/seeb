              ...
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    <tr>
                      ...
                      <td height="75" class="inner" valign="middle"><a href="#"><img class="logo" src="https://www.euripedesbarsanulfo.org.br/sistema/ferramenta/templates_email/img/logo.png" width="200" height="58" alt="Logo"></a></td>
                    </tr>
                  </table>
                  <table width="150" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                      <td align="center"><a href="https://www.euripedesbarsanulfo.org.br/" class="top-button" style="font:bold 13px/37px Arial, Helvetica, sans-serif; color:#ffffff; text-decoration:none; background:#0F7AB1; display:block; border-radius:24px; text-transform:uppercase;">ACESSAR SITE</a></td>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td width="93.33%"><a href="'.$envio["link_emkt_envio"].'"><img class="imgresponsive" src="https://www.euripedesbarsanulfo.org.br/conteudos/email_marketing/'.$envio["imagem_emkt_envio"].'" width="554" height="atuo" alt="Banner" /></a></td>
                      <td width="3.33%" class="sidespace">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="full">
  <tr>
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth" style="background-color:#0F7AB1;">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-image:url(https://www.euripedesbarsanulfo.org.br/sistema/ferramenta/templates_email/images/white-bg.gif); background-repeat:repeat-x; background-position:left top;">
              <tr style="background-color:#FFF;">
                <td height="23">&nbsp;</td>
              </tr>
              <tr>
                <td align="center"><img src="https://www.euripedesbarsanulfo.org.br/sistema/ferramenta/templates_email/images/picture.png" width="83" height="auto" alt="picture" /></td>
              </tr>
              <tr>
                <td height="25">&nbsp;</td>
              </tr>
              <tr>
                <td style="background-color:#0F7AB1;"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      <td width="23" class="sidespace">&nbsp;</td>
                      <td align="center" style="font:15px/19px Arial, Helvetica, sans-serif; color:#ffffff;">A “Sociedade Espírita Eurípedes Barsanulfo” é uma sociedade civil, religiosa, filantrópica e cultural, sem fins lucrativos</td>
                      <td width="23" class="sidespace">&nbsp;</td>
                    </tr>
                  </table></td>
              </tr>
                ...
                <td><table class="inner" align="right" width="340" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                  ...
                  <table class="inner" align="left" width="230" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#000000;">Sociedade Espírita Eurípedes Barsanulfo</td>
                          </tr>
                          <tr>
                            <td height="18">&nbsp;</td>
                          </tr>
