    ...
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#f1f1f1" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
            ...
            <tr>
              <td align="center" class="smallfont" style="font:300 27px Open Sans, Arial, Helvetica, sans-serif; color:#252525;">Olá <span class="smallfont" style="font:700 27px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">'.$usuario["nome_site_usuario"].'</span>, Segue abaixo os dados do seu pedido</td>
            </tr>
            <tr>
