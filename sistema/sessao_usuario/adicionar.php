...
if(decodifica($_POST["acao"]) == "adicionar"){
    ...
    // Insere o usuario
    $usuarios = $pdo->prepare("INSERT INTO usuario 
                            (nome_usuario,
                            telefone_usuario, 
                            email_usuario, 
                            senha_usuario,
    ...
    if($error_log){
        redireciona("/sistema/sessao_usuario/consultar.php?me=".codifica(1,true)."&mm=".codifica("Ops, algo deu errado na inclusão do usuario!")); 
    }else{
        redireciona("/sistema/sessao_usuario/consultar.php?me=".codifica(0,false)."&mm=".codifica("O usuario foi adicionado com sucesso!")); 
    }
}
?>
<!doctype html>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <form method="post" action="sessao_usuario/adicionar.php" class="form-horizontal" multipart="" enctype="multipart/form-data">
