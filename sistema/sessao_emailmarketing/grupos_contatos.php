...
<?php
    ...
    //consulta contatos
    $sql_consulta_contatos = "SELECT codigo_emkt_contato, nome_emkt_contato, email_emkt_contato, status_emkt_contato FROM emkt_contato ORDER BY nome_emkt_contato ASC";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <button type="button" rel="tooltip" class="btn btn-success" onclick="adicionarGrupo();">
                                            <span class="btn-label">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-center"><?php echo $grupo["codigo_emkt_grupo"];?></td>
                                                        <td><?php echo $grupo["titulo_emkt_grupo"];?></td>
                                                        <td class="td-actions text-right">
                                                            <a href="sessao_emailmarketing/contatos.php?codigo_grupo=<?php echo codifica($grupo["codigo_emkt_grupo"]);?>">
                                                                <button type="button" rel="tooltip" class="btn btn-warning" title="Visualizar contatos deste grupo">
                                                                    <i class="material-icons">account_circle</i>
                                                                </button>
                                                            </a>
                                                            <a href="sessao_emailmarketing/editar_grupocontato.php?codigo_grupo=<?php echo codifica($grupo["codigo_emkt_grupo"]);?>">
                                                                <button type="button" rel="tooltip" class="btn btn-info" title="">
                                                                    <i class="material-icons">create</i>
                                                                </button>
                                                            </a>
                                                            <button type="button" rel="tooltip" class="btn btn-danger" onclick="removerGrupo('<?php echo codifica($grupo["codigo_emkt_grupo"]);?>')">
                            ...
                            <div class="col-md-8">
                                ...
                                <button type="button" rel="tooltip" class="btn btn-info" onclick="adicionarContato();">
                                            <span class="btn-label">
                                            <i class="material-icons">add</i>
                                            </span>
                                            ADICIONAR CONTATO
