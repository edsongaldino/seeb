...
if(decodifica($_POST["acao"]) == "adicionar-cliente"){
    ...
    // Insere o produto
    $cliente = $pdo->prepare("INSERT INTO cliente 
                            (nome_cliente, arquivo, status)
                            VALUES
                            (:nome_cliente, :arquivo, :status)");
    ...
    if($error_log){
        redireciona("/sistema/sessao_cliente/consultar.php?me=".codifica(1,true)."&mm=".codifica("Ops, algo deu errado na inclusão da cliente!")); 
    }else{
        redireciona("/sistema/sessao_cliente/consultar.php?me=".codifica(0,false)."&mm=".codifica("A cliente foi adicionada com sucesso!")); 
    }
}
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <form method="post" action="sessao_cliente/adicionar.php" class="form-horizontal" multipart="" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="acao" id="acao" value="<?php echo codifica("adicionar-cliente"); ?>">
                                    <input type="hidden" name="codigo_cliente" id="codigo_cliente" value="<?php echo codifica($codigo_cliente); ?>">
                                    <button type="submit" class="btn btn-fill btn-rose salvar">Gravar cliente</button>
                                </form>
                            </div>
