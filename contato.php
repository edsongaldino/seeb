    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="text-white font-weight-bold">Contact</h2>
                <ol class="breadcrumb">
                    <li>
...
<!-- Google Map -->
<section class="map">
    <div id="map_canvas" data-latitude=" 51.5223477 "
    data-longitude=" -0.1622023 " data-marker=" http://demo.themefisher.com/themefisher/biztrox-hugo/images/marker.png  "></div>
</section>
<!-- /google map -->
